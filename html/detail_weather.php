...
?>
                <p class="in_sen_title" id="divicename_200005075"><?php echo $r['location_name'] ?>气象参数</p>  
                	<?php
                	...
                	for($i=0;$i < $result->field_count;$i++)
                	{
                		...
                		$sql_str = "select * from device_view where serial='".$col_name->name."' and (type_id >= 12 and type_id <= 15)";
					//	echo $sql_str;
