...
<?php
$select_all_id = "select distinct id from device_view where type_id >= 12 and type_id <= 15";
...
?>
                <div class="index_imgInfo_big">
                   <div class="index_img_infosN">
				        <div class="in_imgN" id="dev_<?php echo $location_id ?>">
				            <a href="detail_weather.php?location=<?php echo $location_id ?>" target="menuFramewth">
        ...
        <div class="content">
            <div id="page_content">
                <iframe id="menuFramewth" name="menuFramewth" src="detail_weather.php?location=<?php echo $location_id ?>" style="overflow:visible;"
