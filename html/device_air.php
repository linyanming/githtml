...
?>
                <div class="index_imgInfo_big">
                   <div class="index_img_infosN">
				        <div class="in_imgN" id="dev_<?php echo $location_id ?>">
				            <a href="detail_air.php?location=<?php echo $location_id ?>" target="menuFrameair">
        ...
        <div class="content">
            <div id="page_content">
                <iframe id="menuFrameair" name="menuFrameair" src="detail_air.php?location=<?php echo $location_id ?>" style="overflow:visible;"
